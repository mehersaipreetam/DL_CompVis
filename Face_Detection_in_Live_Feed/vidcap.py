...
while key != ord("q"):
    ...
    # To avoid https://stackoverflow.com/questions/30508922/error-215-empty-in-function-detectmultiscale, mention complete file path when not executing from terminal/cmd prompt
